...
class QuickPipeline_mod(TransformerMixin):
    """
    QuickPipeline: this is modified for fit & transform sklearn pipeline use
    ...
    def fit(self, df, df2=None):
        return self
    
    def transform(self, df, df2=None):
        '''
